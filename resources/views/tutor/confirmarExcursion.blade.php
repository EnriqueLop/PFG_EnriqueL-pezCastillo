      ...
      <div class="row">
        <div class="col-md-10">
          <div class="main-card mb-3 card">
              <div class="card-header">Asistencia a la excursión en {{$actividad->lugar}}</div>
              <div class="card-body">
                    ...
                    @csrf
                      <div class="position-relative form-check">
                        <label class="form-check-label">
                          ...
                          Doy mi consentimiento a que {{$hijo->name}} se guarden los datos para tener un control de asistencia a la actividad hasta finalizar el curso académico.
                        </label>
                      </div>
                      <br>
                      <div class="position-relative form-check">
                        <label class="form-check-label">
                          ...
                          Doy mi consentimiento que {{$hijo->name}} vaya a la excursión.
                        </label>
                      </div>
